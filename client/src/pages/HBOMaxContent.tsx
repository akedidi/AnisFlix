...
export default function HBOMaxContent() {
  ...
  return (
    <CommonLayout 
      title="HBO Max" 
      icon={<img src="https://image.tmdb.org/t/p/original/jbe4gVSfRlbPTdESXhEKpornsfu.jpg" alt="HBO Max" className="w-12 h-12 rounded-lg" />}
      showSearch={true}
    >
      ...
      <div className="relative bg-gradient-to-b from-primary/20 to-background">
        <div className="container mx-auto px-4 md:px-8 lg:px-12 py-8">
          <div className="flex items-center gap-4 mb-4">
            <img
              src="https://image.tmdb.org/t/p/original/jbe4gVSfRlbPTdESXhEKpornsfu.jpg"
              alt="HBO Max"
              className="w-12 h-12 rounded-lg"
            />
            <div>
              <h1 className="text-3xl md:text-4xl font-bold">HBO Max</h1>
              <p className="text-muted-foreground">
                Découvrez tous les films et séries disponibles sur HBO Max.
              </p>
            </div>
          </div>
        </div>
