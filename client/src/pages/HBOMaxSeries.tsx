...
export default function HBOMaxSeries() {
  ...
  const { restoreScrollPosition } = useScrollPosition('hbo-max-series');
  ...
  // HBO Max specific series genres
  const { data: actionSeriesData } = useSeriesByProviderAndGenre(1899, 10759); // Action & Adventure
  const { data: comedySeriesData } = useSeriesByProviderAndGenre(1899, 35); // Comedy
  const { data: dramaSeriesData } = useSeriesByProviderAndGenre(1899, 18); // Drama
  const { data: crimeSeriesData } = useSeriesByProviderAndGenre(1899, 80); // Crime
  const { data: mysterySeriesData } = useSeriesByProviderAndGenre(1899, 9648); // Mystery
  const { data: sciFiSeriesData } = useSeriesByProviderAndGenre(1899, 10765); // Sci-Fi & Fantasy
  const { data: thrillerSeriesData } = useSeriesByProviderAndGenre(1899, 53); // Thriller
  const { data: animationSeriesData } = useSeriesByProviderAndGenre(1899, 16); // Animation
  const { data: documentarySeriesData } = useSeriesByProviderAndGenre(1899, 99); // Documentary
  const { data: realitySeriesData } = useSeriesByProviderAndGenre(1899, 10764); // Reality
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-xl font-semibold">Séries HBO Max</h1>
            </div>
            ...
            <div className="flex items-center gap-2">
              <SearchBar
                ...
                placeholder="Rechercher des séries HBO Max..."
              />
              <LanguageSelect />
              <ThemeToggle />
            </div>
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        {!searchQuery && (
          <>
            {/* Latest HBO Max Series */}
            <div className="space-y-6">
              <h2 className="text-2xl font-semibold">Dernières séries HBO Max</h2>
              {seriesLoading ? (
                <div className="text-center py-12">
                  <p className="text-muted-foreground">Chargement des séries HBO Max...</p>
                </div>
              ) : series.length > 0 ? (
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
            ...
            {actionSeries.length > 0 && (
              <div className="space-y-6">
                <h2 className="text-2xl font-semibold">Séries Action HBO Max</h2>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
            ...
            {comedySeries.length > 0 && (
              <div className="space-y-6">
                <h2 className="text-2xl font-semibold">Séries Comédie HBO Max</h2>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
            ...
            {dramaSeries.length > 0 && (
              <div className="space-y-6">
                <h2 className="text-2xl font-semibold">Séries Drame HBO Max</h2>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
            ...
            {mysterySeries.length > 0 && (
              <div className="space-y-6">
                <h2 className="text-2xl font-semibold">Séries Mystère HBO Max</h2>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
            ...
            {sciFiSeries.length > 0 && (
              <div className="space-y-6">
                <h2 className="text-2xl font-semibold">Séries Science-Fiction HBO Max</h2>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
            ...
            {thrillerSeries.length > 0 && (
              <div className="space-y-6">
                <h2 className="text-2xl font-semibold">Séries Thriller HBO Max</h2>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
            ...
            {animationSeries.length > 0 && (
              <div className="space-y-6">
                <h2 className="text-2xl font-semibold">Séries Animation HBO Max</h2>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
            ...
            {realitySeries.length > 0 && (
              <div className="space-y-6">
                <h2 className="text-2xl font-semibold">Séries Téléréalité HBO Max</h2>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
