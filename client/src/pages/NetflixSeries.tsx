    ...
    const fetchData = async () => {
      try {
        ...
        const response = await fetch(
          `https://api.themoviedb.org/3/discover/tv?api_key=f3d757824f08ea2cff45eb8f47ca3a1e&with_watch_providers=8&watch_region=FR&with_watch_monetization_types=flatrate&vote_average_gte=5&page=${currentPage}`
        );
    ...
    <div className="min-h-screen fade-in-up">
      ...
      <div className="relative bg-gradient-to-b from-primary/20 to-background pt-20 md:pt-20">
        <div className="container mx-auto px-4 md:px-8 lg:px-12 py-8">
          <h1 className="text-3xl md:text-4xl font-bold mb-2">Séries Netflix</h1>
          <p className="text-muted-foreground mb-4 max-w-2xl">
            Découvrez les séries disponibles sur Netflix.
          </p>
        </div>
      </div>
