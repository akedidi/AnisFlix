...
export default function NetflixSeries() {
  ...
  const { restoreScrollPosition } = useScrollPosition('netflix-series');

  // Fetch data from TMDB - Only Netflix series
  const { data: seriesData, isLoading: seriesLoading } = useSeriesByProvider(8, currentPage);
  const { data: searchResults = [] } = useMultiSearch(searchQuery);

  // Netflix specific series genres
  const { data: actionSeriesData } = useSeriesByProviderAndGenre(8, 10759); // Action & Adventure
  const { data: comedySeriesData } = useSeriesByProviderAndGenre(8, 35); // Comedy
  const { data: dramaSeriesData } = useSeriesByProviderAndGenre(8, 18); // Drama
  const { data: crimeSeriesData } = useSeriesByProviderAndGenre(8, 80); // Crime
  const { data: mysterySeriesData } = useSeriesByProviderAndGenre(8, 9648); // Mystery
  const { data: sciFiSeriesData } = useSeriesByProviderAndGenre(8, 10765); // Sci-Fi & Fantasy
  const { data: thrillerSeriesData } = useSeriesByProviderAndGenre(8, 53); // Thriller
  const { data: animationSeriesData } = useSeriesByProviderAndGenre(8, 16); // Animation
  const { data: documentarySeriesData } = useSeriesByProviderAndGenre(8, 99); // Documentary
  const { data: realitySeriesData } = useSeriesByProviderAndGenre(8, 10764); // Reality
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-xl font-semibold">Séries Netflix</h1>
            </div>
            ...
            <div className="flex items-center gap-2">
              <SearchBar
                ...
                placeholder="Rechercher des séries Netflix..."
              />
              <LanguageSelect />
              <ThemeToggle />
            </div>
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        {!searchQuery && (
          <>
            ...
            <div className="space-y-6">
              <h2 className="text-2xl font-semibold">Dernières séries Netflix</h2>
              {seriesLoading ? (
                <div className="text-center py-12">
                  <p className="text-muted-foreground">Chargement des séries Netflix...</p>
                </div>
              ) : series.length > 0 ? (
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
                ...
                <p className="text-muted-foreground">Aucune série Netflix disponible</p>
              )}
            </div>
            ...
            {actionSeries.length > 0 && (
              <div className="space-y-6">
                <h2 className="text-2xl font-semibold">Séries Action Netflix</h2>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
            ...
            {comedySeries.length > 0 && (
              <div className="space-y-6">
                <h2 className="text-2xl font-semibold">Séries Comédie Netflix</h2>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
            ...
            {dramaSeries.length > 0 && (
              <div className="space-y-6">
                <h2 className="text-2xl font-semibold">Séries Drame Netflix</h2>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
            ...
            {sciFiSeries.length > 0 && (
              <div className="space-y-6">
                <h2 className="text-2xl font-semibold">Séries Science-Fiction Netflix</h2>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
            ...
            {thrillerSeries.length > 0 && (
              <div className="space-y-6">
                <h2 className="text-2xl font-semibold">Séries Thriller Netflix</h2>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
            ...
            {animationSeries.length > 0 && (
              <div className="space-y-6">
                <h2 className="text-2xl font-semibold">Séries Animation Netflix</h2>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
            ...
            {documentarySeries.length > 0 && (
              <div className="space-y-6">
                <h2 className="text-2xl font-semibold">Documentaires Netflix</h2>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
            ...
            {realitySeries.length > 0 && (
              <div className="space-y-6">
                <h2 className="text-2xl font-semibold">Séries Téléréalité Netflix</h2>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
