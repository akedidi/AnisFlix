...
export default function PopularSeries() {
  ...
  const { data: seriesData, isLoading: seriesLoading } = usePopularSeries(currentPage    </div>
  );
}
    ...
    <div className="min-h-screen fade-in-up">
      ...
      <div className="relative bg-gradient-to-b from-primary/20 to-background">
        <div className="container mx-auto px-4 md:px-8 lg:px-12 py-8">
          ...
          <p className="text-muted-foreground mb-4 max-w-2xl">
            Découvrez les séries les plus populaires du moment selon les spectateurs.
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-12 py-8">
        {seriesLoading ? (
          ...
          <div className="text-center py-12">
            <p className="text-muted-foreground">Aucune série populaire disponible</p>
          </div>
        )}
      </div>
