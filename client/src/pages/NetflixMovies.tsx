...
export default function NetflixMovies() {
  ...
  const { restoreScrollPosition } = useScrollPosition('netflix-movies');
  ...
  // Netflix specific movie genres
  const { data: actionMoviesData } = useMoviesByProviderAndGenre(8, 28); // Action
  const { data: comedyMoviesData } = useMoviesByProviderAndGenre(8, 35); // Comedy
  const { data: dramaMoviesData } = useMoviesByProviderAndGenre(8, 18); // Drama
  ...
  const { data: sciFiMoviesData } = useMoviesByProviderAndGenre(8, 878); // Science Fiction
  const { data: fantasyMoviesData } = useMoviesByProviderAndGenre(8, 14); // Fantasy
  const { data: animationMoviesData } = useMoviesByProviderAndGenre(8, 16); // Animation
  const { data: documentaryMoviesData } = useMoviesByProviderAndGenre(8, 99); // Documentary
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        {!searchQuery && (
          <>
            ...
            <div className="space-y-6">
              <h2 className="text-2xl font-semibold">Derniers films Netflix</h2>
              {moviesLoading ? (
            ...
            {comedyMovies.length > 0 && (
              <div className="space-y-6">
                <h2 className="text-2xl font-semibold">Films Comédie Netflix</h2>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
            ...
            {dramaMovies.length > 0 && (
              <div className="space-y-6">
                <h2 className="text-2xl font-semibold">Films Drame Netflix</h2>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
            ...
            {horrorMovies.length > 0 && (
              <div className="space-y-6">
                <h2 className="text-2xl font-semibold">Films Horreur Netflix</h2>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
            ...
            {sciFiMovies.length > 0 && (
              <div className="space-y-6">
                <h2 className="text-2xl font-semibold">Films Science-Fiction Netflix</h2>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
            ...
            {fantasyMovies.length > 0 && (
              <div className="space-y-6">
                <h2 className="text-2xl font-semibold">Films Fantastique Netflix</h2>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
            ...
            {animationMovies.length > 0 && (
              <div className="space-y-6">
                <h2 className="text-2xl font-semibold">Films Animation Netflix</h2>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
