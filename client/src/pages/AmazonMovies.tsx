...
export default function AmazonMovies() {
  ...
  const { restoreScrollPosition } = useScrollPosition('amazon-movies');
  ...
  // Amazon Prime specific movie genres
  ...
  const { data: romanceMoviesData } = useMoviesByProviderAndGenre(9, 10749); // Romance
  const { data: thrillerMoviesData } = useMoviesByProviderAndGenre(9, 53); // Thriller
  const { data: horrorMoviesData } = useMoviesByProviderAndGenre(9, 27); // Horror
  const { data: sciFiMoviesData } = useMoviesByProviderAndGenre(9, 878); // Science Fiction
  const { data: fantasyMoviesData } = useMoviesByProviderAndGenre(9, 14); // Fantasy
  const { data: animationMoviesData } = useMoviesByProviderAndGenre(9, 16); // Animation
  const { data: documentaryMoviesData } = useMoviesByProviderAndGenre(9, 99); // Documentary
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-xl font-semibold">Films Amazon Prime</h1>
            </div>
            ...
            <div className="flex items-center gap-2">
              <SearchBar
                ...
                placeholder="Rechercher des films Amazon Prime..."
              />
              <LanguageSelect />
              <ThemeToggle />
            </div>
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        {!searchQuery && (
          <>
            {/* Latest Amazon Prime Movies */}
            <div className="space-y-6">
              <h2 className="text-2xl font-semibold">Derniers films Amazon Prime</h2>
              {moviesLoading ? (
                <div className="text-center py-12">
                  <p className="text-muted-foreground">Chargement des films Amazon Prime...</p>
                </div>
              ) : movies.length > 0 ? (
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
            ...
            {actionMovies.length > 0 && (
              <div className="space-y-6">
                <h2 className="text-2xl font-semibold">Films Action Amazon Prime</h2>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
            ...
            {dramaMovies.length > 0 && (
              <div className="space-y-6">
                <h2 className="text-2xl font-semibold">Films Drame Amazon Prime</h2>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
            ...
            {romanceMovies.length > 0 && (
              <div className="space-y-6">
                <h2 className="text-2xl font-semibold">Films Romance Amazon Prime</h2>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
            ...
            {thrillerMovies.length > 0 && (
              <div className="space-y-6">
                <h2 className="text-2xl font-semibold">Films Thriller Amazon Prime</h2>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
            ...
            {horrorMovies.length > 0 && (
              <div className="space-y-6">
                <h2 className="text-2xl font-semibold">Films Horreur Amazon Prime</h2>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
            ...
            {sciFiMovies.length > 0 && (
              <div className="space-y-6">
                <h2 className="text-2xl font-semibold">Films Science-Fiction Amazon Prime</h2>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
            ...
            {fantasyMovies.length > 0 && (
              <div className="space-y-6">
                <h2 className="text-2xl font-semibold">Films Fantastique Amazon Prime</h2>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
            ...
            {animationMovies.length > 0 && (
              <div className="space-y-6">
                <h2 className="text-2xl font-semibold">Films Animation Amazon Prime</h2>
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
