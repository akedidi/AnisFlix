...
async function getM3u8Link(url) {
    try {
        console.log(`Récupération du HTML depuis : ${url}`);
...
const embedUrl = 'https://vidzy.org/embed-5rflb5fhc2po.html';

getM3u8Link(embedUrl).then(link => {
    if (link) {
        console.log("\nLien M3U8 Extrait :\n", link);
    }
});