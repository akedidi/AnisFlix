    ...
    try {
        ...
        if (type === 'series' && req.query.filter === 'last-episodes') {
            ...
            try {
                ...
                // Streaming: Netflix (213), Amazon (1024), Apple TV+ (2552), Disney+ (2739), Hulu (453), Crunchyroll (1112), AMC+ (4661), Sundance Now (2363), TVA+ (4590), Hallmark+ (7635)
                // Premium: HBO (49), HBO Max (3186, 8304), Max (6783), Showtime (67), Starz (318), Peacock (3353), Paramount+ (4330), OWN (827), Adult Swim (80)
                // US/UK Broadcast: NBC (6), ABC (2), CBS (16), Fox (19), FX (88), Warner Bros (3267), BBC One (4), BBC Two (332), National Geographic (43), AMC (174), Hallmark (384)
                // French/CA: Canal+ (285), TF1 (290), M6 (712), M6+ (6694), Arte (662, 1628), ADN (2278), TVA (302), CBC (23), Global TV (218), ICI Radio-Canada (141)
                // International: HBO España (3877), SBS (156), MBS (94), TBS (160)
