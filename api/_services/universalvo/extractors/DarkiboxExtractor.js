            ...
            if (packedMatch) {
                ...
                if (unpacker.detect()) {
                    ...
                    if (unpacked) {
                        ...
                        if (!m3u8Url) {
                            // Priority 3: Check for download link explicitly
                            const downloadMatch = unpacked.match(/download\s*:\s*["']([^"']+)["']/i);
                            if (downloadMatch) {
                                m3u8Url = downloadMatch[1];
                                console.log('[DarkiboxExtractor] Found download link in unpacked JS:', m3u8Url);
                            }
                        }
                    }
                }
