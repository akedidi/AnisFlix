...
#ifndef ANISFLIX_SWIFT_H
#define ANISFLIX_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="anisflix",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class UIApplication;
@class NSString;
SWIFT_CLASS("_TtC8anisflix11AppDelegate")
...
SWIFT_CLASS("_TtC8anisflix11CastManager")
@interface CastManager : NSObject <GCKRemoteMediaClientListener, GCKSessionManagerListener>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC8anisflix15DownloadManager")
...
@class NSURL;
@class NSValue;
@interface DownloadManager (SWIFT_EXTENSION(anisflix)) <AVAssetDownloadDelegate>
...
@interface DownloadManager (SWIFT_EXTENSION(anisflix)) <NSURLSessionDownloadDelegate>
- (void)URLSession:(NSURLSession * _Nonnull)session downloadTask:(NSURLSessionDownloadTask * _Nonnull)downloadTask didFinishDownloadingToURL:(NSURL * _Nonnull)location;
- (void)URLSession:(NSURLSession * _Nonnull)session downloadTask:(NSURLSessionDownloadTask * _Nonnull)downloadTask didWriteData:(int64_t)bytesWritten totalBytesWritten:(int64_t)totalBytesWritten totalBytesExpectedToWrite:(int64_t)totalBytesExpectedToWrite;
@end

@class NSURLSessionTask;
@interface DownloadManager (SWIFT_EXTENSION(anisflix)) <NSURLSessionTaskDelegate>
- (void)URLSession:(NSURLSession * _Nonnull)session task:(NSURLSessionTask * _Nonnull)task didCompleteWithError:(NSError * _Nullable)error;
- (void)URLSessionDidFinishEventsForBackgroundURLSession:(NSURLSession * _Nonnull)session;
@end

@class NSCoder;
SWIFT_CLASS("_TtC8anisflix10PlayerView")
...
SWIFT_CLASS("_TtC8anisflix15PlayerViewModel")
