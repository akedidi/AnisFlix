...
struct Localizable {
    ...
    private static let frenchTranslations: [String: String] = [
        ...
        "downloads.cancelAlertTitle": "Annuler le téléchargement ?",
        "downloads.cancelAlertMessage": "Voulez-vous vraiment annuler ce téléchargement ?",
    ...
    private static let englishTranslations: [String: String] = [
        ...
        "downloads.cancelAlertTitle": "Cancel Download?",
        "downloads.cancelAlertMessage": "Are you sure you want to cancel this download?",
    ...
    private static let spanishTranslations: [String: String] = [
        ...
        "downloads.cancelAlertTitle": "¿Cancelar descarga?",
        "downloads.cancelAlertMessage": "¿Estás seguro de que deseas cancelar esta descarga?",
    ...
    private static let arabicTranslations: [String: String] = [
        ...
        "downloads.queued": "في الانتظار",
        "downloads.restart": "إعادة التشغيل",
        ...
        "downloads.cancelAlertTitle": "إلغاء التحميل؟",
        "downloads.cancelAlertMessage": "هل أنت متأكد من رغبتك في إلغاء هذا التحميل؟",
    ...
    private static let germanTranslations: [String: String] = [
        ...
        "downloads.cancelAlertTitle": "Download abbrechen?",
        "downloads.cancelAlertMessage": "Möchten Sie diesen Download wirklich abbrechen?",
    ...
    private static let italianTranslations: [String: String] = [
        ...
        "downloads.queued": "In coda",
        "downloads.restart": "Ricomincia",
        ...
        "downloads.cancelAlertTitle": "Annullare?",
        "downloads.cancelAlertMessage": "Sei sicuro di voler annullare questo download?",
    ...
    private static let portugueseTranslations: [String: String] = [
        ...
        "downloads.cancelAlertTitle": "Cancelar download?",
        "downloads.cancelAlertMessage": "Tem a certeza de que deseja cancelar?",
