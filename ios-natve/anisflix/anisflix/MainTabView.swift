...
struct MainTabView: View {
    ...
    var body: some View {
        TabView(selection: $selectedTab) {
            ...
            .tabItem {
                Label(theme.t("nav.movies"), systemImage: selectedTab == 1 ? "film.fill" : "film")
            }
            .tag(1)
            ...
            .tabItem {
                Label(theme.t("nav.series"), systemImage: selectedTab == 2 ? "tv.fill" : "tv")
            }
            .tag(2)
            ...
            .tabItem {
                Label(theme.t("nav.tvChannels"), systemImage: selectedTab == 3 ? "radio.fill" : "radio")
            }
            .tag(3)
            ...
            .tabItem {
                Label(theme.t("nav.settings"), systemImage: selectedTab == 6 ? "gearshape.fill" : "gearshape")
            }
            .tag(6)
        }
