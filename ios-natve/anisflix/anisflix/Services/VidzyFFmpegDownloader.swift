//
//  VidzyFFmpegDownloader.swift
//  anisflix
//
//  Created for downloading Vidzy HLS streams with custom headers using FFmpegKit
//
...
class VidzyFFmpegDownloader {
    ...
    func downloadVidzy(url: String, 
        ...
        print("🎬 [VidzyFFmpeg] Starting download")
        print("   - URL: \(url)")
        print("   - Output: \(outputPath)")
        
        // Build headers for Vidzy
        let headers = "Referer: https://vidzy.org/\\r\\nUser-Agent: Mozilla/5.0 (iPhone; CPU iPhone OS 16_0 like Mac OS X) AppleWebKit/605.1.15\\r\\nAccept: */*\\r\\n"
