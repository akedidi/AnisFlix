...
class TVService {
    ...
    private var channels: [TVChannel] = [
        ...
        TVChannel(id: "bein-sports-5-ar", name: "Bein Sports 5 (Ar)", logo: "https://upload.wikimedia.org/wikipedia/commons/1/1a/BeIN_SPORTS_5_logo.png", streamUrl: "", category: "Arab", group: "Sport", epgId: nil, links: [
            TVChannelLink(type: "hls_segments", url: "https://prod-fastly-eu-west-1.video.pscp.tv/Transcoding/v1/hls/MEEM0GKsrHzJvI14RwxWUya0VEZuONNQHo9-EAsQGgo7vRdz3mVaon7RNfRx4IPVIQpCCenBAk2uZPwAxL_vkQ/non_transcode/eu-west-1/periscope-replay-direct-prod-eu-west-1-public/master_dynamic_delta.m3u8?type=live")
        ]),
